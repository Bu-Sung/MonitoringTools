        ...
        <div class="d-flex justify-content-center">
            <div class="card mt-8 col-lg-5 col-md-8 col-sm-11">
                <div class="card-body my-4 text-center mx-4">
                    <h5 class="fw-700 mb-4">⚠️  ERROR  ⚠️</h5>
                        <div class="d-flex justify-content-center">잘못된 접근입니다.</div>
                    <button id="backBTN" class="btn btn-outline-primary mt-4">이전 페이지로 이동</button>
                </div>
            </div>
        </div>
        <script>
