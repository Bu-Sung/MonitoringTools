            ...
            <div class="card card-blue row mx-auto mb-5" style="height: viewportHeight;">
                ...
                <div class="card card-white-0 mx-auto" style="height: viewportHeight;">
                    <div class="col-md-10 col-11 mx-auto my-5">
                        <h4 class="fw-600 text-dark mb-4">공지사항 작성 페이지</h4>
                        <div class="card card-white-1 p-4">
                            <div id="meeting">
                                <form id="documentForm" method="POST" action="addBoard"
                                      enctype="multipart/form-data" onsubmit="saveDocument()">
                                    <div class="align-items-center mb-4">
                                        <div>
                                            <span class="fw-bold">카테고리 : </span>
                                            <select id="category" name="category" class="border p-1 fw-500" style="border-radius: 0.3rem; appearance: none;">
                                    ...
                                    <input class="form-control border mb-3" type="file" id="file" name="file"
                                           multiple>
