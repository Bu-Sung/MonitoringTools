                    ...
                    <div class="row mx-auto px-0">
                        ...
                        <div class="card card-white-0 col-md-9 col-12 mx-auto order-md-1" style="height: viewportHeight;">
                            <div class="col-11 mx-auto my-5">
                                ...
                                <div class="card card-white-1 mb-4">
                                    <div class="card-body">
                                        <a href="/monitoring/project/kanban" class="text-dark fw-600">나의 스프린트<i class="bi bi-chevron-right"></i></a>
                                ...
                                <div class="card card-white-1 mb-4">
                                    <div class="card-body">
                                        <a href="/monitoring/project/schedule" class="text-dark fw-600">오늘 나의 일정<i class="bi bi-chevron-right"></i></a>
                                        <div class="mt-3">
                                            <table>
                                                <tr class="text-primary">
                                                    <th colspan="5">시간</th>
