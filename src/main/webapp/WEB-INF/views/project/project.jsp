                        ...
                        <div class="card card-white-0 col-md-9 col-12 mx-auto order-md-1" style="height: viewportHeight;">
                            <div class="col-11 mx-auto my-5">
                                ...
                                <div class="card card-white-1 mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <p class="text-dark fw-600">나의 스프린트</p>
                                            <a href="/monitoring/project/kanban" class="text-dark fw-600">전체보기<i class="bi bi-chevron-right"></i></a>
                                        </div>
                                        <div class="mt-1" style="overflow: auto; white-space: nowrap;">
                                            <table>
                                ...
                                <div class="card card-white-1 mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <p class="text-dark fw-600">오늘의 일정</p>
                                        <a href="/monitoring/project/schedule" class="text-dark fw-600">전체 보기<i class="bi bi-chevron-right"></i></a>
                                        </div>
                                        <div class="mt-1">
                                            <table>
                                                <tr class="text-primary">
                                                ...
                                                <c:forEach items="${todaySchedule}" var="list">
                                                    <tr>
                                                        <c:set var="time" value="${list.start}"/>
                                                        <c:if test="${list.allTime eq 1}">
                                                            <c:set var="time" value="${list.start} ~ ${list.end}"/>
                                                        </c:if>    
                                                        <td>${time}</td>
                                                        <td>${list.title}</td>
                                                    </tr>
