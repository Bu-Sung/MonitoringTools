...
public class UserController {
     ...
     */
    @PostMapping("/chagePw")
    public String chagePw(@ModelAttribute UserDTO userDTO, HttpServletRequest request) {
    ...
    @PostMapping("/pwcheck")
    public @ResponseBody
    boolean pwCheck(@RequestBody String pw) {
    ...
    public @ResponseBody boolean deleteUser(RedirectAttributes attrs, HttpServletRequest request) {
        if(userService.deleteUser(sessionManager.getUserId())){
            HttpSession session = request.getSession();
            session.invalidate();
            return true;
        }else{
